...
class ComprehensiveReportGenerator:
            ...
            if file_path.exists():
                try:
                    with open(file_path, 'r', encoding='utf-8') as f:
                        ...
                        print(f"[OK] Loaded {step} results")
    ...
    def generate_markdown_report(self):
        ...
        print(f"[OK] Comprehensive research report saved to: {report_file}")
    ...
    def generate_technical_appendix(self):
        ...
        print(f"[OK] Technical appendix saved to: {appendix_file}")
...
def main():
    ...
    generator = ComprehensiveReportGenerator(output_path)
    ...
    print(f"Technical appendix: {appendix_file}")
